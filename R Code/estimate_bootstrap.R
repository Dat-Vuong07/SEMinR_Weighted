  ...
  out <- tryCatch(
    {
      ...
      if (nboot > 0) {
        ...
        getEstimateResults <- function(i, d = d) {
          ...
          # weight_vector = c(rep(1,250))
          
            list_file <- list.files("/Users/vuongdat/OneDrive - Aarhus universitet/Research/seminr/R2")
            for (j in list_file) { 
              source(paste0("/Users/vuongdat/OneDrive - Aarhus universitet/Research/seminr/R2/", j))
            }
